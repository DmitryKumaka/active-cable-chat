...
(function() {
  App.appearance = App.cable.subscriptions.create("AppearanceChannel", {
    ...
    received: function(data) {
      ...
      if (data['message']['appear'] === false) {
        return status.append('<div class="status" style="background-color: white;"></div>');
      }
    },
    disappear: function() {
  ...
  $(document).on('ready page:load', function() {
    ...
    $('.logout_header').click(function() {
      return App.appearance.disappear();
    });
    idleTimer = null;
    idleState = false;
    idleWait = 300000;
    return $(document).bind('mousemove', function() {
...
(function() {
  App.chat = App.cable.subscriptions.create("ChatChannel", {
    ...
    disconnected: function() {},
    received: function(data) {
      var current_user_email, current_user_id, recipient_user_email, room_id;
      ...
      if (room_id === data['message']['room_id']) {
        if (data['message']['user_id'] === current_user_id) {
          $('.message-block').append('<div class="current-user-message">' + current_user_email + '</div> ' + '<div class="curr-msg-cont">' + data['message']['content'] + '</div>');
          return $('.form-control').val("");
        } else {
          $('.message-block').append('<div class="recipient-message">' + recipient_user_email + '</div> ' + '<div class="res-msg-cont">' + data['message']['content'] + '</div>');
          return $('.form-control').val("");
        }
      }
    }
